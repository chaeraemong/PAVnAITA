...
def auto_eval(args, task_set, final_predicted_labels, model):
    ...
    output_json_path = os.path.join(args.trajectories_dir, f"{args.app_name}__{args.method}__score_threshold_{args.score_threshold}__autoeval_results.json")
    ...
    for task_id in task_set:
        ...
        with open(os.path.join(args.trajectories_dir, f"{args.app_name}__{args.method}__score_threshold_{args.score_threshold}__autoeval_results.json"), "a+") as f_out:
