...
def auto_eval(args, task_set, final_predicted_labels, model, task_folder_name):
    ################## get the already done task id ###############
    input_json_path = os.path.join(args.trajectories_dir, task_folder_name, f"{args.category.upper()}-{args.inst_id}.json")
    ...
    for task_id in task_set:
        ...
        for result in results:
            ...
            # print("result_action_type : ", result_action_type)
            # print("result_action_text : ", result_action_text)
...
def parallel_eval(args):
    ...
    task_folder_name = args.category.upper() + '-' + args.inst_id + '-' + args.trial
    # args.output_path = args.trajectories_dir + '/' + task_folder_name
    args.output_path = args.trajectories_dir
    
    task_set = [f'{task_folder_name}']
    final_predicted_labels = []
    final_predicted_labels = auto_eval(args, task_set, final_predicted_labels, model, task_folder_name)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--inst_id", type=str, default="9103121876", help="Instruction ID")
    parser.add_argument("--trial", type=str, default="1", help="Trial(0~4)")
